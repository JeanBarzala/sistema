                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="b" placeholder="Ingrese número de remision o pedido" class="form-control buscador">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-condensed table-hover">
                    ...
                    <tbody>
                      @foreach ($remisiones as $remision)
                        <tr>
                          <td>{{ $remision->id_pedido }}</td>
                          <td>{{ $remision->numero_remision }}</td>
                          <td>{{ $remision->pedido->persona_recibe_pedido }}</td>
                          <td>{{ $remision->pedido->fecha_hora_entrega_pedido }}</td>
                          <td>{{ $remision->observacion_remision }}</td>
                          <td>
                            @if ($remision->fecha_anulacion_remision != NULL )
                          ...
                          <td class="text-right">
                              <a href="#" class="btn btn-primary btn-sm">Ver remision</a>
