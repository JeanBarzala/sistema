                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="b" placeholder="Ingrese número de factura o pedido" class="form-control buscador">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-condensed table-hover">
                    ...
                    <tbody>
                      @foreach ($facturas as $factura)
                        <tr>
                          <td>{{ $factura->makeNumero() }}</td>
                          <td>{{ $factura->id_pedido }}</td>
                          <td>{{ $factura->tipo_pago_factura }}</td>
                          <td>{{ $factura->fecha_registro_factura }}</td>
                          <td>
                            @if ($factura->estado_factura == 'ANULADA')
                            <span class="label label-danger">{{ $factura->estado_factura }}</span>
                            @else
