        ...
        <div class="row">
          ...
          <div class="col-lg-6">
              <div class="form-group">
                  ...
                  <input type="text" name="descripcion_caja" class="form-control" value="{{ old('descripcion_caja') }}">
              </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="form-group">
              ...
              <select name="estado_caja" class="form-control">
                <option value="HABILITADA" {{ old('estado_caja') == 'HABILITADA' ? 'selected' : '' }}>Activo</option>
                <option value="" {{ old('estado_caja') != 'HABILITADA' ? 'selected' : '' }}>Inactivo</option>
              </select>
            </div>
          </div>
